...
class ReferencementController extends Controller
{
    ...
    public function secAction(/*Categories $categorie = null*/)
    {
        ...
        if ($session->has('affichage'))
            ...
            $affichage =array(
                ...
                'habillage_name' => NULL,
                'banniere_name' => NULL,
                'banniere_name_ext' => NULL,

                'banniere_clas_ext' => null,
                ...
                'banniere_nombr_ext' =>NULL,
                'bann_up_engin_ext' =>NULL,
                'bann_down_engin_ext' =>NULL,
                'bann_up_customer_ext' =>NULL,
                'bann_down_customer_ext'=>NULL,
        ...
        if($session->has('ReseauxCA'))
            $ReseauxCA =$session->get('ReseauxCA');
        else
            $ReseauxCA =array(
                'social_clic'=>Null,
                'social_clic_impressions'=>Null,
                'social_contact'=>Null,
                'social_contact_impressions'=>Null,
                'social_video'=>Null,
                'social_video_vues'=>Null,
                'audit'=>Null,
    ...
    public function pdfAction(Request $request)
    {
        ...
        if($request->isMethod('Post')) {
           ...
           $prof = $session->get('prof');
            ...
            $filenamed25  =  "Vignette-classique.pdf";
            ...
            if( in_array("Vignette_classique.", $join) ){

                $pdfdocd25 = file_get_contents("http://www.telecontact.ma/trouver/pdf_new/Vignette-classique.pdf");
 ...
 Bien cordialement';
        ...
        if( in_array("Video_corporate", $join) ){
        ...
        if( in_array("Video_graphique", $join) ){
    ...
    public function rcaAction(Request $request)
    {


        $rca = $request->request->get('nbr');

        $result =array('rca'=> $rca);

        $this->get('session')->set('rca', $rca);
    ...
    public function affichageAction(Request $request)
    {
        ...
        $banniere_clas_ext= intval( $request->request->get('banniere_clas_ext'));
        ...
        $banniere_name_ext = intval( $request->request->get('banniere_name_ext'));
        $banniere_nombr_ext = $request->request->get('nombre_ext');

        $bann_up_engin_ext = $request->request->get('bann_up_engin_ext');
        $bann_down_engin_ext = $request->request->get('bann_down_engin_ext');
        $bann_up_customer_ext = $request->request->get('bann_up_customer_ext');
        $bann_down_customer_ext = $request->request->get('bann_down_customer_ext');
        ...
        $result =array(
            ...
            'banniere_clas_ext' => $banniere_clas_ext,

            'banniere_name' => $banniere_name,
            'banniere_name_ext' => $banniere_name_ext,
            ...
            'banniere_nombr_ext' =>$banniere_nombr_ext,
            'bann_up_engin_ext' =>$bann_up_engin_ext,
            'bann_down_engin_ext' =>$bann_down_engin_ext,
            'bann_up_customer_ext' =>$bann_up_customer_ext,
            'bann_down_customer_ext'=>$bann_down_customer_ext,
    ...
    public function ReseauxCAAction(Request $request)
    {
        $social_clic = $request->request->get('social_clic');
        $social_clic_impressions = $request->request->get('social_clic_impressions');
        $social_contact = $request->request->get('social_contact');
        $social_contact_impressions = $request->request->get('social_contact_impressions');
        $social_video = $request->request->get('social_video');
        $social_video_vues = $request->request->get('social_video_vues');
        $audit = $request->request->get('audit');
        $result =array(
            'social_clic'=>$social_clic,
            'social_clic_impressions'=>$social_clic_impressions,
            'social_contact'=>  $social_contact,
            'social_contact_impressions'=>  $social_contact_impressions,
            'social_video'=>  $social_video,
            'social_video_vues'=>  $social_video_vues,
            'audit'=>  $audit,
        );
        $this->get('session')->set('ReseauxCA', $result);
