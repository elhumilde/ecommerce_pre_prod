...
class ProduitsController extends Controller
{
    ...
    public function reseauxsociaxauditAction()
    {
        $session = $this->getRequest()->getSession();
        $em = $this->getDoctrine()->getManager();
        ...
        if ($session->has('raison'))
            ...
            $raison = array('profession'=>NULL);
        return $this->render('EcommerceBundle:Default:produits/layout/reseauxsociaux_audit.html.twig',array('ReseauxCA' =>$ReseauxCA,'raison' =>$raison ));
    }
    ...
    public function autresProfessionAction()
        {
            return $this->render('EcommerceBundle:Default:lien/autres_professions.html.twig');
        }
    public function banniereExtensibleAction()
    {
        return $this->render('EcommerceBundle:Default:lien/bannieres_extensibles.html.twig');
    }
    public function facebookAdsAction()
    {
        return $this->render('EcommerceBundle:Default:lien/facebook.html.twig');
    }
